...
* **Planning and Reasoning**: Focus on equipping generative agents with human-level planning and reasoning capabilities, including constrained planning, tool invocation and multitasking planning.
* **Cognitive Modeling**: Explore cognitive knowledge in generative agents to enable them to generate responses that align better with human cognition, including multi-agent collaboration, analogical reasoning, role-playing, belief exploration.
...
* (Download my [resumé](http://siyuyuan.github.io/uploads/resume.pdf). The last update was on 2024-12.)
